...
execute if score #id1 homes.dummy > #id2 homes.dummy run function homes:helper/bubble_1
execute if score #id2 homes.dummy > #id1 homes.dummy run function homes:helper/bubble_2
