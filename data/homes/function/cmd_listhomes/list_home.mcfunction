...
execute unless score #remaining homes.dummy matches 1 run function homes:helper/bubble
...
execute if score #reducedDebugInfo homes.dummy matches 1 run function homes:cmd_listhomes/display_home_with_reduced_info
execute unless score #reducedDebugInfo homes.dummy matches 1 run function homes:cmd_listhomes/display_home_with_all_info
...
execute unless score #homes homes.dummy matches 0 run function homes:cmd_listhomes/list_home