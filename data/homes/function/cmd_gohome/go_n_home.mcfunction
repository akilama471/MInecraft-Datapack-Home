...
execute as @e[type=minecraft:marker,tag=homes.dimension] run function homes:helper/try_to_summon_destination
...
execute as @e[type=minecraft:marker,tag=homes.destination,limit=1] run function homes:helper/set_destination
