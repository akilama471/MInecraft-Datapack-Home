...
execute if score #value homes.dummy = @s homes.y run function homes:helper/check_x
...
execute unless score #success homes.dummy matches 0 run function homes:cmd_gohome/try_to_go_home
